...
const searchRef =
  ref<InstanceType<(typeof import("element-plus"))["ElHeader"]>>();
...
function applyCollapsedDisplay() {
  ...
  if (slotRef.value) {
    slotRef.value.style.display =
      collapsed.value && slotOverflow.value ? "none" : "inline-block";
  }
}
