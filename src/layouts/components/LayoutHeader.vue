      ...
      <slot name="right">
        <div class="layout-header__tools">
          ...
          >
            <button
              type="button"
              class="layout-header__tool"
              @click="noticeStore.openDrawer()"
            >
              <el-badge
          ...
          >
            <button
              type="button"
              class="layout-header__tool"
              @click.stop="handleFullscreenClick"
            >
              <el-icon :size="18">
...
import NoticeInbox from "@/components/NoticeInbox/NoticeInbox.vue";
